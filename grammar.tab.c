...
{
       0,    39,    39,    40,    41,    42,    46,    47,    48,    67,
      71,   107,   108,   116,   117,   121,   130,   139,   150,   151,
     152,   156,   157,   165,   168,   175,   188
};
#endif
...
static const char *const yytname[] =
{
  ...
  "STRING", "EXIT", "WHILE", "lTYPE", "'\\n'", "'{'", "'<'", "'>'", "'='",
  "$accept", "input", "line", "assignment", "value", "loop", "condition",
...
{
       6,   -16,    33,   -16,   -16,   -15,     1,   -16,    -5,    -1,
     -16,    -4,    10,    -2,    48,   -16,   -16,   -16,    23,     1,
      27,   -16,   -16,     1,     1,   -16,     1,     1,   -16,    34,
      19,    41,    25,    25,    48,    48,    24,     1,     1,    29,
     -16,   -16,    25,   -16,    25,    25,     1,    25
};
...
{
       0,     5,    13,     1,    24,    25,     0,     4,     0,     0,
       3,     0,     0,     0,    20,    23,     8,    25,     0,     0,
       0,     7,     9,     0,     0,     6,     0,     0,    26,     0,
       0,     0,    18,    19,    21,    22,     0,     0,     0,     0,
      12,    10,    11,    14,    15,    16,     0,    17
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -16,   -16,   -16,   -16,   -16,   -16,   -16,    -6,    30,   -16
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,    10,    11,    41,    12,    29,    13,    14,    15
};
...
{
      18,    16,    23,    24,     4,    19,    -2,     1,    20,    -2,
      17,     6,    21,    30,    25,    -2,    -2,    32,    33,    -2,
      -2,    -2,    -2,    23,    24,    42,    22,    23,    24,    23,
      24,    44,    45,     3,    28,    31,     4,    37,    38,    39,
      47,    43,     5,     6,     4,    36,     7,     8,     9,    46,
      17,     6,     0,    40,    26,    27,    34,    35
};

static const yytype_int8 yycheck[] =
{
       6,    16,     4,     5,     3,    10,     0,     1,     9,     3,
       9,    10,    16,    19,    16,     9,    10,    23,    24,    13,
      14,    15,    16,     4,     5,    31,    16,     4,     5,     4,
       5,    37,    38,     0,    11,     8,     3,    18,    19,    20,
      46,    17,     9,    10,     3,    11,    13,    14,    15,    20,
       9,    10,    -1,    12,     6,     7,    26,    27
};
...
{
       0,     1,    22,     0,     3,     9,    10,    13,    14,    15,
      23,    24,    26,    28,    29,    30,    16,     9,    28,    10,
       9,    16,    16,     4,     5,    16,     6,     7,    11,    27,
      28,     8,    28,    28,    29,    29,    11,    18,    19,    20,
      12,    25,    28,    17,    28,    28,    20,    28
};
...
#line 46 "CES/grammar.y"
                    {printf("%d\n>>", (yyvsp[-1].num));}
#line 1136 "grammar.tab.c"
    break;

  case 7: /* line: assignment '\n'  */
#line 47 "CES/grammar.y"
                      {printf(">>");}
#line 1142 "grammar.tab.c"
    break;

  case 8: /* line: IDENT '\n'  */
#line 48 "CES/grammar.y"
                    {
...
#line 1166 "grammar.tab.c"
  ...
  case 9: /* line: loop '\n'  */
#line 67 "CES/grammar.y"
                     {printf("test\n>>");}
#line 1172 "grammar.tab.c"
    break;

  case 10: /* assignment: lTYPE IDENT EQ value  */
#line 71 "CES/grammar.y"
                             {
...
#line 1221 "grammar.tab.c"
  ...
  case 14: /* loop: WHILE PARENT_L condition PARENT_R '{'  */
#line 117 "CES/grammar.y"
                                                {printf("");}
#line 1227 "grammar.tab.c"
    break;

  case 15: /* condition: expression '<' expression  */
#line 121 "CES/grammar.y"
                                {
...
#line 151 "CES/grammar.y"
                                  {(yyval.num) = (yyvsp[-2].num) - (yyvsp[0].num); }
#line 1281 "grammar.tab.c"
    break;

  case 20: /* expression: term  */
#line 152 "CES/grammar.y"
            { (yyval.num) = (yyvsp[0].num); }
#line 1287 "grammar.tab.c"
    break;

  case 21: /* term: term MULTIPLY term  */
#line 156 "CES/grammar.y"
                       { (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); }
#line 1293 "grammar.tab.c"
    break;

  case 22: /* term: term DIVIDE term  */
...
#line 1318 "grammar.tab.c"
  ...
  case 25: /* factor: IDENT  */
#line 175 "CES/grammar.y"
                        { 
...
#line 1336 "grammar.tab.c"
  ...
  case 26: /* factor: PARENT_L expression PARENT_R  */
