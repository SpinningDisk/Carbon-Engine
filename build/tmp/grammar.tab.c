...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PARENT_L = 10,                  /* PARENT_L  */
  YYSYMBOL_PARENT_R = 11,                  /* PARENT_R  */
  YYSYMBOL_STRING = 12,                    /* STRING  */
  YYSYMBOL_EXIT = 13,                      /* EXIT  */
  YYSYMBOL_WHILE = 14,                     /* WHILE  */
  YYSYMBOL_printstack = 15,                /* printstack  */
...
{
       0,    39,    39,    40,    41,    42,    45,    49,    50,    51,
      70,    74,   110,   111,   119,   120,   124,   133,   142,   153,
     154,   155,   159,   160,   168,   171,   178,   191
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MINUS", "MULTIPLY", "DIVIDE", "EQ", "IDENT", "PARENT_L", "PARENT_R",
  "STRING", "EXIT", "WHILE", "printstack", "lTYPE", "'\\n'", "'{'", "'<'",
  "'>'", "'='", "$accept", "input", "line", "assignment", "value", "loop",
...
{
       7,   -17,    34,   -17,   -17,   -16,    50,   -17,    -4,   -17,
      16,   -17,    -8,    23,    -2,    24,   -17,   -17,   -17,     0,
      50,    38,   -17,   -17,    50,    50,   -17,    50,    50,   -17,
      44,     8,    42,    31,    31,    24,    24,    39,    50,    50,
      21,   -17,   -17,    31,   -17,    31,    31,    50,    31
};
...
{
       0,     6,    14,     1,    25,    26,     0,     4,     0,     5,
       0,     3,     0,     0,     0,    21,    24,     9,    26,     0,
       0,     0,     8,    10,     0,     0,     7,     0,     0,    27,
       0,     0,     0,    19,    20,    22,    23,     0,     0,     0,
       0,    13,    11,    12,    15,    16,    17,     0,    18
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -17,   -17,   -17,   -17,   -17,   -17,   -17,    -6,    11,   -17
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,    11,    12,    42,    13,    30,    14,    15,    16
};
...
{
      19,    17,    24,    25,    24,    25,    20,    -2,     1,    22,
      -2,    29,    24,    25,    31,    26,    -2,    -2,    33,    34,
      -2,    -2,    -2,    -2,    -2,    21,    43,    38,    39,    40,
      27,    28,    45,    46,     3,    24,    25,     4,    35,    36,
      23,    48,    47,     5,     6,     4,    32,     7,     8,     9,
      10,    18,     6,     4,    41,    37,     0,    44,     0,    18,
       6
};

static const yytype_int8 yycheck[] =
{
       6,    17,     4,     5,     4,     5,    10,     0,     1,    17,
       3,    11,     4,     5,    20,    17,     9,    10,    24,    25,
      13,    14,    15,    16,    17,     9,    32,    19,    20,    21,
       6,     7,    38,    39,     0,     4,     5,     3,    27,    28,
      17,    47,    21,     9,    10,     3,     8,    13,    14,    15,
      16,     9,    10,     3,    12,    11,    -1,    18,    -1,     9,
      10
};
...
{
       0,     1,    23,     0,     3,     9,    10,    13,    14,    15,
      16,    24,    25,    27,    29,    30,    31,    17,     9,    29,
      10,     9,    17,    17,     4,     5,    17,     6,     7,    11,
      28,    29,     8,    29,    29,    30,    30,    11,    19,    20,
      21,    12,    26,    29,    18,    29,    29,    21,    29
};
...
#line 41 "CES/grammar.y"
                      {printf("bye!\n"); return 0;}
#line 1127 "grammar.tab.c"
    break;

  case 5: /* input: input printstack  */
#line 42 "CES/grammar.y"
                          {for(int i=0; i<VM.queue.len; i++){
...
#line 1135 "grammar.tab.c"
  ...
  case 6: /* input: error  */
#line 45 "CES/grammar.y"
                {printf("\n"); return 0;}
#line 1141 "grammar.tab.c"
    break;

  case 7: /* line: expression '\n'  */
#line 49 "CES/grammar.y"
                    {printf("%d\n>>", (yyvsp[-1].num));}
#line 1147 "grammar.tab.c"
    break;

  case 8: /* line: assignment '\n'  */
...
#line 1177 "grammar.tab.c"
  ...
  case 10: /* line: loop '\n'  */
#line 70 "CES/grammar.y"
                     {printf("test\n>>");}
#line 1183 "grammar.tab.c"
    break;

  case 11: /* assignment: lTYPE IDENT EQ value  */
#line 74 "CES/grammar.y"
                             {
...
#line 1232 "grammar.tab.c"
  ...
  case 15: /* loop: WHILE PARENT_L condition PARENT_R '{'  */
...
#line 1252 "grammar.tab.c"
  ...
  case 17: /* condition: expression '>' expression  */
#line 133 "CES/grammar.y"
                               {
        if((yyvsp[-2].num)>(yyvsp[0].num)){
            printf("True");
            (yyval.num) = 1;
...
#line 1266 "grammar.tab.c"
  ...
  case 18: /* condition: expression '=' '=' expression  */
#line 142 "CES/grammar.y"
                                  {
...
#line 153 "CES/grammar.y"
                               {(yyval.num)=(yyvsp[-2].num)+(yyvsp[0].num);bytecode New_Code;New_Code.opcode=ADD;New_Code.operantAmount=2;}
#line 1286 "grammar.tab.c"
    break;

  case 20: /* expression: expression MINUS expression  */
#line 154 "CES/grammar.y"
                                  {(yyval.num) = (yyvsp[-2].num) - (yyvsp[0].num); }
#line 1292 "grammar.tab.c"
    break;

  case 21: /* expression: term  */
#line 155 "CES/grammar.y"
            { (yyval.num) = (yyvsp[0].num); }
#line 1298 "grammar.tab.c"
    break;

  case 22: /* term: term MULTIPLY term  */
#line 159 "CES/grammar.y"
                       { (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); }
#line 1304 "grammar.tab.c"
    break;

  case 23: /* term: term DIVIDE term  */
#line 160 "CES/grammar.y"
                       {
        if((yyvsp[0].num)==0){
...
#line 1347 "grammar.tab.c"
  ...
  case 27: /* factor: PARENT_L expression PARENT_R  */
#line 191 "CES/grammar.y"
